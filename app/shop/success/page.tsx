...
const paymentLabel = (method?: string | null, status?: string | null) => {
  ...
  if (method === 'mercadopago' && status === 'paid') return 'Mercado Pago aprobado'
  if (method === 'mercadopago' && status === 'failed') return 'Mercado Pago rechazado'
  if (method === 'mercadopago' && status === 'mercadopago_create_failed') return 'Mercado Pago no iniciado'
  if (method === 'mercadopago') return 'Mercado Pago pendiente'
